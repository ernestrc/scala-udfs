...
class DeserializeUserSpec extends WordSpec with Matchers {
  ...
  "DeserializeUser UDF should serialize a user from a paper trail string" in {
    val mess = """
                 |---
                 |email: foo@bar.com
